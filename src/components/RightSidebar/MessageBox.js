            ...
            {chat.map((m, index) =>
              m.sender === "me" ? (
                <RightChatBubble
                  ...
                  key={index}
                  name={"Neha"}
                  image={"https://media.licdn.com/dms/image/D4D03AQHDf8b8q2xZUQ/profile-displayphoto-shrink_400_400/0/1694112529324?e=1703721600&v=beta&t=qA9sYNNVdldOlFVK7Q5q-w4qG0J0Cgf8uXzHZcElnK4"}
                />
              ) : (
                <LeftChatBubble
                  message={m}
